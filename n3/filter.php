...
<p align="center"><b>All the rejected quotations are listed below <br/>
</b></p>
		</div>
		</div>
</div>
 ...
 ?>  
    <tr>
		...
		<div class="row">
			...
			<a href="final.php?user_id=<?php echo $row['email'];?>&company=<?php echo $row['company'];?>&category=<?php echo $row['category'];?>" class="btn btn-secondary" >
			Approve</a>
			</div>
