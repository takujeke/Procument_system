...
if(isset($_POST['signupSubmit'])){
        ...
        if($_POST['password'] !== $_POST['confirm_password']){
            ...
            if($prevUser > 0){
                ...
                if($insert){
                    ...
                    $sessData['status']['msg'] = 'Account has been created. Please log again in with your credentials to activate your account.';
                }else{
                    $sessData['status']['type'] = 'error';
    ...
    if(!empty($_POST['email']) && !empty($_POST['password'])){
        ...
        if($userData){
            ...
            $sessData['status']['type'] = 'error';
            $sessData['status']['msg'] = 'Wrong email or password has been provided. Please try again.'; 
        }
    }else{
        $sessData['status']['type'] = 'error';
